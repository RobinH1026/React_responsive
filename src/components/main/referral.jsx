                            ...
                            <div className='mobile_referral' style={{ width:'80%' }}>
                                ...
                                <div style={{ display:"flex", marginTop:"-20px" }}>
                                    <div style={{ width:"45%" }}>
                                        ...
                                        <input className='inputStyle' type="text" name="first_Name" defaultValue='Harry' placeholder='Enter ...' />
                                    </div>
                                    <div style={{ width: "45%",marginLeft:"auto", marginTop:"-45px" }}>
                                        <p className='loginTitle' style={{ marginTop:"75px", color: "#002554" }}>Last name *</p>
                                        <input className='inputStyle' type="text" name="last_Name" defaultValue='Hekimian' placeholder='Enter ...' />
                                    </div>
                                </div>
                                <p className='loginTitle' style={{ marginTop:"25px", color: "#002554" }}>Email *</p>
                                <input className='inputStyle' type="text" defaultValue='harry@malopan.com' placeholder='Enter ...' />
                            ...
                            <div className='mobile_last_invitation'>
                                ...
                                <div className='mobile_index_content topboder' style={{ marginTop:'70px' }}>
                                    <div style={{ display:'flex' }}>
                                        ...
                                        <p style={{ marginLeft:"auto", fontSize:'16px', fontColor:'#002554' }}>05/05/2021</p>
                                    </div>
                                    <div style={{ display:'flex' }}>
                                        <p style={{ fontSize:'16px', fontWeight:'600', fontColor:'#002554' }}>First name</p>
                                        <p style={{ marginLeft:"auto", fontSize:'16px', fontColor:'#002554' }}>Harry</p>
                                    </div>
                                    <div style={{ display:'flex' }}>
                                        <p style={{ fontSize:'16px', fontWeight:'600', fontColor:'#002554' }}>Last name</p>
                                        <p style={{ marginLeft:"auto", fontSize:'16px', fontColor:'#002554' }}>Hekimian</p>
                                    </div>
                                    <div style={{ display:'flex' }}>
                                        <p style={{ fontSize:'16px', fontWeight:'600', fontColor:'#002554' }}>Email</p>
                                        <p style={{ marginLeft:"auto", fontSize:'16px', fontColor:'#002554' }}>harry@malopan.com</p>
                                    </div>
                                    <div style={{ display:'flex' }}>
